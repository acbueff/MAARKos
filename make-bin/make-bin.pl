...
# simple Perl script to convert executable binary to text
# input: an executable file
# output: a text file of the same name with extension .bin

$#ARGV == 0 || die "Usage: make-bin.pl (.s file, e.g., sleep.s)\n";
